                ...
                <div className="row justify-content-center mx-2">
                    ...
                    <h4 className='text-center'>{loading?<Loading/>:error?<Error error="Registeration failed"/>:success?<Success success="Registeration successfull"/>:""}</h4>
                        <form onSubmit={submit}>
                            ...
                            <input type="text" placeholder='Confirm Password' className='form-control my-3' name="cpassword" onChange={change} value={data.cpassword} required autoComplete='off'/>
